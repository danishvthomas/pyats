    ...
    if uut.name in conf_dict['bgp']['mvpn'].keys():
        if not str(31) in uut.name:
            ...
            for neighbor in neigh_list:
                ...
                cfg+= "send-community\n"
                cfg+= "send-community extended\n"
                #if 'bgw' in uut.name or 'dci' in uut.name:
                    #cfg+= "ebgp-multihop 255\n"
                #    cfg+= "rewrite-rt-asn\n"      
...
#leaf13fx3# sh int br | inc Adm
#Eth1/17         --      eth  routed down    Administratively down    auto(D) --
#Eth1/39         --      eth  routed down    Administratively down    auto(D) --
##Eth1/41         --      eth  routed down    Administratively down    auto(D) --
#Eth1/53         --      eth  routed down    Administratively down    auto(D) --
