...
class CommonSetup(aetest.CommonSetup):
    ...
    def connect_to_tb_devices(self, testbed,build=""):
        ...
        uut_list=[leaf11,leaf12,leaf21,leaf22,leaf31,spine,sw1,sw2]
        ...
        #mac_start1 = conf_dict['fhs_test']['mac_address']['sw1']['mac_start']
        #mac_start2 = conf_dict['fhs_test']['mac_address']['sw3']['mac_start']
        #mac_start3 = conf_dict['fhs_test']['mac_address']['sw3']['mac_start']
        #sw1_svi_mac = conf_dict['fhs_test']['mac_address']['sw1Svi']['mac_add']
        #sw2_svi_mac = conf_dict['fhs_test']['mac_address']['sw2Svi']['mac_add']
        #sw3_svi_mac = conf_dict['fhs_test']['mac_address']['sw3Svi']['mac_add']
